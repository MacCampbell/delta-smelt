...
```{r}
tops<-reads %>% top_frac(.8, Counts) %>% filter(sex!=0)
...
-yBin $HOME/delta-smelt/phenos/2012.phenos -cov $HOME/delta-smelt/phenos/2012.cov -minMapQ 20 -minQ 20 -minInd 98 -doAsso 2 \
...
srun -p high -t 48:00:00 --mem=32G --nodes=2 $HOME/angsd/angsd -P 24  -bam $HOME/delta-smelt/bamlists/2012.bamlist \
-yBin $HOME/delta-smelt/phenos/2012.phenos -minMapQ 20 -minQ 20 -minInd 98 -doAsso 2 -doPost 1 -GL 1 -minCount 2 \
