...
# 
#Colv= FALSE,
pdf(file="outputs/figure-3/figure-3.pdf", width=11, height=14)
heatmap.2(as.matrix(snpsites), labCol="", cexRow = 0.6,
          labRow="",
          colRow = cols$Color, RowSideColors = cols$Color,
          trace="none",
